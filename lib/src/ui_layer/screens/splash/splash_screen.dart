...
import 'package:astro_app/src/business_layer/localization/translations.dart';
...
import 'package:astro_app/src/business_layer/util/helper/screen_navigation_helper.dart';
...
import 'package:astro_app/src/feed_app.dart';
import 'package:astro_app/src/ui_layer/screens/base_widget.dart';
import 'package:astro_app/src/ui_layer/screens/splash/splash_screen_main_widget.dart';
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void _onAfterBuild() async {
    ...
    navigatorKey.currentState?.pushReplacement(ScreenNavigation.createRoute(
        widget: BaseWidget(),
        routeNames: RouteNames.baseScreen,
        showPageRoute: true));
  }
}
