...
import 'package:astro_app/src/data_layer/res/images.dart';
...
class CommonButton extends StatelessWidget {
  ...
  String label;
  CommonButton(
      {Key? key, this.active = true, this.onTap, this.icon, this.label = ""})
      : super(key: key);
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
            ...
            color: active ? Colors.orange : deactivatButtonColor,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(color: Colors.green, width: d_1),
